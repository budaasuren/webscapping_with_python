# webscapping_with_python

Identified HTML elements on a page by using inspect, identified their id and class attributes, 
and used this knowledge to extract information via both automated browsing with Splinter and HTML parsing with Beautiful Soup. 
Scraped various types of information from the web including HTML tables and recurring elements.
